...
public class CyrillicChars {
	...
	for(int i=0; i<acceptables.length; i++){
	    if(test_char.equals(acceptables[i])){
		return true;
	    }
	}
	return false;
